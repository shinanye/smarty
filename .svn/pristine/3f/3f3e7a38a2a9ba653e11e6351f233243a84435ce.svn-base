<?php
/* Smarty version 3.1.30, created on 2018-03-18 05:41:04
  from "D:\wamp64\www\mbkj\app\index\view\casePanel\product.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5aadfbf02dadb8_79897231',
...
function content_5aadfbf02dadb8_79897231 (Smarty_Internal_Template $_smarty_tpl) {
?>
        ...
        $.ajax({
            ...
            success:function(data){
               ...
               for(var i=0;i<data.length;i++){
                   var id = data[i]['Id'];
                    var _div = ' <div class="h3-con"> <div class="clearfix u-product-content"> <a href="?c=index&a=product&id='+id+'"><img src='+data[i]['coverimg']+'> <div><h1>'+data[i]['title']+'</h1><p>'+data[i]['smallcontent']+'</p></div></a></div><div>';
                    main.append(_div);
                }
            },
            error:function(){
