<?php
/* Smarty version 3.1.30, created on 2018-03-18 03:17:19
  from "D:\wamp64\www\mbkj\app\index\view\casePanel\seek.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5aadda3f527c75_27033816',
...
function content_5aadda3f527c75_27033816 (Smarty_Internal_Template $_smarty_tpl) {
?>
    ...
    <main>
        ...
        <div class="consult-content">
            <div class="consult-content-in">
                                    <a href="?c=index&a=seek&page=2&id=17">
                        <div class="consult-list clearfix">
                            <img src=http://www.chinamobo.com/data/attachment/image/20171117/20171117142439_97187.jpg style="width:270px;height:180px;">
                            <div class="list-right">
                                <h1>汽车培训行业即将加速，请扶稳坐好！</h1>
                                <p>
                                    近日，德莫特尔与魔学院达成战略合作！作为战略合作伙伴，德莫特尔将会与魔学院重点针对汽车行业培训开展一系列从内容到平台的深度合作。
                                </p>
                                <ul>
                                    <li>发布时间：2017 年 11 月 17 日 </li>
                                    <li>阅读全文</li>
                                </ul>
                                <br>
                                    ...
                                    <a href="?c=index&a=seek&page=2&id=15">
                        <div class="consult-list clearfix">
                            <img src=http://www.chinamobo.com/data/attachment/image/20171116/20171116144730_22002.jpg style="width:270px;height:180px;">
                            <div class="list-right">
                                <h1>asdadaddaqqqqq</h1>
                                <p>
                                    qweqweqwe
                                </p>
                                <ul>
                                    <li>发布时间：2018年03月15日 </li>
                                    <li>阅读全文</li>
                                </ul>
                                <br>
                                    ...
                                    <a href="?c=index&a=seek&page=2&id=16">
                        <div class="consult-list clearfix">
                            <img src=http://www.chinamobo.com/data/attachment/image/20171116/20171116144847_28280.jpg style="width:270px;height:180px;">
                            <div class="list-right">
                                <h1>ewqe</h1>
                                <p>
                                    qweqweqwe
            ...
            <div class="pagination">
                                <a href="?c=index&a=seek&page=1">1</a>
                                <a href="?c=index&a=seek&page=2">2</a>
                                <a href="?c=index&a=seek&page=3">3</a>
                                <a href="?c=index&a=seek&page=4">4</a>
                                <a href="?c=index&a=seek&page=5">5</a>
...
?>
            var _div = $(".list-right").eq(<?php echo $_smarty_tpl->tpl_vars['k']->value;?>
);
            var _p = "<div class='read'>阅读量：<span class='readnum'><?php echo $_smarty_tpl->tpl_vars['value']->value['readnum'];?>
</span></div>";
            _div.append(_p);
        <?php
}
