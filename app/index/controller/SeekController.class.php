...
class SeekController extends Controller{
    ...
    public function seek()//调用display方法显示哪一个页面
    {
        # code...
        ...
        $this->instanceSa->assign("page",$_GET["page"]);
        $this->createPages();
    ...
    public function seekPagination(Type $var = null)//获取每一页显示的信息
    {
        if($_GET["page"]<=$this->allPages){
            ...
            $this->data = $this->model->paginFormation($this->count,$offset);//offset是偏移量可有可无，count是每次请求的数量
            $this->instanceSa->assign("data",$this->data);
        }
